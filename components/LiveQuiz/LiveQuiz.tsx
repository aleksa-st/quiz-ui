                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 sm:p-8 border border-white/20">
                        ...
                        <div className="bg-white rounded-2xl p-8">
                            <p className="text-center text-gray-600 py-12">
                                Enter session code screen coming soon...
                                <br />
                                <span className="text-sm">This will let you enter a 6-digit code</span>
                            </p>
                            <button
                                onClick={() => {
                                    // For now, join a mock session
                                    const mockCode = prompt('Enter session code:');
                                    if (mockCode) {
                                        handleJoinSession(mockCode);
                                    }
                                }}
                                className="w-full mt-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 rounded-xl font-bold hover:scale-105 transition-transform"
                            >
                                Enter Code (Mock)
                            </button>
                        </div>
            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 sm:p-8 border border-white/20">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        >
                            <div className="w-16 h-16 bg-gradient-to-br from-green-400 to-blue-500 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform shadow-lg">
