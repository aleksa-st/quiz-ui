            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <select
                        ...
                        className="px-4 py-2 bg-white border border-slate-200 rounded-lg text-slate-700 font-medium shadow-sm focus:ring-2 focus:ring-indigo-500 outline-none"
                    >
                            ...
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <div className="flex bg-slate-100 rounded-lg p-1">
                                    <button
                                        ...
                                        className={`px-3 py-1 text-sm font-medium rounded-md transition-all ${chartMetric === 'accuracy' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
                                    >
                                        Accuracy
                                    </button>
                                    <button
                                        onClick={() => setChartMetric('score')}
                                        className={`px-3 py-1 text-sm font-medium rounded-md transition-all ${chartMetric === 'score' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
                                    >
                                        Score
                                    </button>
                                </div>
